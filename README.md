...
The repository is organized by programming language. Each language folder contains the same set of sixteen demos, each targeting a specific Copilot feature.
