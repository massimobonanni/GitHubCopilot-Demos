...
The repository is organized by programming language. Each language folder contains a sequence of demos targeting specific Copilot features. Every language track includes a GitHub Copilot CLI demo, and the C#, JavaScript, and Python tracks also include a GitHub Copilot desktop app demo.
...
| `Java/` | Java (JDK 17+) | [Java/README.md](Java/README.md) |
...
| 18 | `18-github-copilot-app` | GitHub Copilot App — coordinate parallel coding sessions from the desktop (C#, JavaScript, and Python tracks) |
