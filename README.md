...
The repository is organized by programming language. Each language folder contains a sequence of demos targeting specific Copilot features. Every language track includes GitHub Copilot CLI and GitHub Copilot desktop app demos.
...
| 18 | `18-github-copilot-app` | GitHub Copilot App — coordinate parallel coding sessions from the desktop |
