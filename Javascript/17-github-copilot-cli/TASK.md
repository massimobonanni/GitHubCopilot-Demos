...
Complete the two unfinished methods in `issueDesk.js` without changing the
public API.
...
- Break any remaining tie by `id`, using case-sensitive string ordering.
...
- [ ] No generated dependency or test output is committed.
